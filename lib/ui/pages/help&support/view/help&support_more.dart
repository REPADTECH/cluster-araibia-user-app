                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children:  <TextSpan>[
                          ...
                          TextSpan(text: '${logic.subject }', style: TextStyle(fontWeight: FontWeight.normal)),
                        ],
                      ),
                    ),
                   ...
                   SizedBox(height: 10,),
                    RichText(
                      text: TextSpan(
                        ...
                        style: DefaultTextStyle.of(context).style,
                        children:  <TextSpan>[
                          TextSpan(text: 'Complaint : ', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: '${logic.complaint }', style: TextStyle(fontWeight: FontWeight.normal)),
                        ],
                      ),
                    ),
                   // Text('Complaint : ${logic.complaint }'),
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        style: DefaultTextStyle.of(context).style,
                        children:  <TextSpan>[
                          TextSpan(text: 'Reply : ', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: '${logic.reply }', style: TextStyle(fontWeight: FontWeight.normal)),
                        ],
                      ),
                    ),
