...
class Coupons {
  ...
  Coupons({this.id, this.couponCode, this.startDate, this.endDate, this.value, this.limit, this.description, this.noMinimumChildren, this.status, this.visibleToAll, this.createdAt, this.updatedAt});
